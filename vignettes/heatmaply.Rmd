...
We can use different colors. For example, we may want to combine the color pallates in order to get divergent colors for the correlations (these will sadly be much less friendly for color blind people):
