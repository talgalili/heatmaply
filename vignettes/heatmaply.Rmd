...
[plotly R package](https://cran.r-project.org/web/packages/plotly/index.html).
...
[`cetcolor`](https://cran.rstudio.com/web/packages/cetcolor/) and 
...
For example, we may want to use other color palettes in order to get divergent colors for the correlations (these will, sadly, often be less useful for 
colorblind people):
...
([Gruvaeus and Wainer](https://www.researchgate.net/publication/230266994_Two_additions_to_hierarchical_cluster_analysis)) 
...
[vignette](https://CRAN.R-project.org/package=dendextend/vignettes/introduction.html) )
...
`heatmaply` also has the option to produce vector graphic equivalents using
the excellent [`egg`](https://cran.r-project.org/web/packages/egg/index.html) 
